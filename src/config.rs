...
lazy_static::lazy_static! {
    ...
    let mut map = HashMap::new();
        map.insert("password".to_string(), "wuhen1997".to_string());
        RwLock::new(map)
    };
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["rustdesk.seeu.top"];
pub const RS_PUB_KEY: &str = "697qIC07e3M05keyp2vJzqyzKOkG4XYU72pxAbE50LU=";
